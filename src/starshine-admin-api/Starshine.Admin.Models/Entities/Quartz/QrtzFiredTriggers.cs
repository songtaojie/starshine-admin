...
public class QrtzFiredTriggers:EntityBase<int>
{
    ...
    /// 任务名字
    /// </summary>
    [SugarColumn(ColumnDescription = "任务名字", ColumnName = "JOB_NAME", Length = 200,IsNullable =true)]
    public string? JobName { get; set; }

    /// <summary>
    /// 任务分组
    /// </summary>
    [SugarColumn(ColumnDescription = "任务分组", ColumnName = "JOB_GROUP", Length =200, IsNullable = true)]
