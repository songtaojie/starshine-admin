...
public class QrtzSimpropTriggers:EntityBase
{
    ...
    /// 浮点型属性1
    /// </summary>
    [SugarColumn(ColumnDescription = "浮点型属性1", ColumnName = "DEC_PROP_1", Length = 13,DecimalDigits =4, IsNullable = true)]
    public decimal? DecProp1 { get; set; }

    /// <summary>
    /// 浮点型属性2
    /// </summary>
    [SugarColumn(ColumnDescription = "浮点型属性2", ColumnName = "DEC_PROP_2", Length = 13, DecimalDigits = 4, IsNullable = true)]
    ...
    ///时区id
    /// </summary>
    [SugarColumn(ColumnDescription = "重复次数", ColumnName = "TIME_ZONE_ID",Length =80, IsNullable = false)]
