...
public class QrtzFiredTriggers//:EntityBase<int>
{
    ///// <summary>
    ///// 自增id
    ///// </summary>
    ...
    /// 调度名字
    /// </summary>
    [SugarColumn(ColumnDescription = "调度名字", ColumnName = "ENTRY_ID", ColumnDataType = "NVARCHAR(140)", IsNullable = false, IsPrimaryKey = true)]
    public string EntryId { get; set; }

    /// <summary>
    /// 触发器名字
    /// </summary>
    [SugarColumn(ColumnDescription = "触发器名字", ColumnName = "TRIGGER_NAME", ColumnDataType = "NVARCHAR(200)", IsNullable = false)]
    public string TriggerName { get; set; }

    /// <summary>
    /// 触发器分组
    /// </summary>
    [SugarColumn(ColumnDescription = "触发器分组", ColumnName = "TRIGGER_GROUP", ColumnDataType = "NVARCHAR(200)", IsNullable = false)]
    public string TriggerGroup { get; set; }

    /// <summary>
    /// 实例的名称
    /// </summary>
    [SugarColumn(ColumnDescription = "实例的名称", ColumnName = "INSTANCE_NAME", ColumnDataType = "NVARCHAR(200)", IsNullable = false)]
    public string InstanceName { get; set; }

    /// <summary>
    /// 触发时间
    /// </summary>
    [SugarColumn(ColumnDescription = "触发时间", ColumnName = "FIRED_TIME", ColumnDataType = "BIGINT", IsNullable = false)]
    public long FireTime { get; set; }

    /// <summary>
    /// 调度时间
    /// </summary>
    [SugarColumn(ColumnDescription = "调度时间", ColumnName = "SCHED_TIME", ColumnDataType = "BIGINT", IsNullable = false)]
    public long SchedTime { get; set; }

    /// <summary>
    /// 优先级
    /// </summary>
    [SugarColumn(ColumnDescription = "优先级", ColumnName = "PRIORITY", ColumnDataType = "INTEGER", IsNullable = false)]
    ...
    /// DELETED：已删除
    /// </summary>
    [SugarColumn(ColumnDescription = "状态", ColumnName = "STATE", ColumnDataType = "NVARCHAR(16)", IsNullable = false)]
    ...
    /// 是否非并发
    /// </summary>
    [SugarColumn(ColumnDescription = "是否非并发", ColumnName = "IS_NONCONCURRENT", ColumnDataType = "BIT", IsNullable = true)]
    ...
    /// </summary>
    [SugarColumn(ColumnDescription = "请求恢复", ColumnName = "REQUESTS_RECOVERY", ColumnDataType = "BIT", IsNullable = true)]
