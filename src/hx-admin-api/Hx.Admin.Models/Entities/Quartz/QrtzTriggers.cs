...
public class QrtzTriggers
{
    ...
    /// 任务名字
    /// </summary>
    [SugarColumn(ColumnDescription = "任务名字", ColumnName = "JOB_NAME", ColumnDataType = "NVARCHAR(200)", IsNullable = false)]
    public string JobName { get; set; }

    /// <summary>
    /// 任务分组
    /// </summary>
    [SugarColumn(ColumnDescription = "任务分组", ColumnName = "JOB_GROUP", ColumnDataType = "NVARCHAR(200)", IsNullable = false)]
    public string JobGroup { get; set; }

    /// <summary>
    /// 描述信息
    /// </summary>
    [SugarColumn(ColumnDescription = "描述信息", ColumnName = "Description", ColumnDataType = "NVARCHAR(250)", IsNullable = true)]
    public string? Description { get; set; }

    /// <summary>
    /// 下次触发时间
    /// </summary>
    [SugarColumn(ColumnDescription = "下次触发时间", ColumnName = "NEXT_FIRE_TIME", ColumnDataType = "BIGINT", IsNullable = true)]
    public long? NextFireTime { get; set; }

    /// <summary>
    /// 上次触发时间
    /// </summary>
    [SugarColumn(ColumnDescription = "上次触发时间", ColumnName = "PREV_FIRE_TIME", ColumnDataType = "BIGINT", IsNullable = true)]
    public long? PrevFireTime { get; set; }

    /// <summary>
    /// 优先级
    /// </summary>
    [SugarColumn(ColumnDescription = "优先级", ColumnName = "PRIORITY", ColumnDataType = "INTEGER")]
    ...
    /// DELETED：已删除
    /// </summary>
    [SugarColumn(ColumnDescription = "触发器状态", ColumnName = "TRIGGER_STATE", ColumnDataType = "NVARCHAR(16)", IsNullable =false)]
    ...
    /// BLOB：一般的blob触发器类型。
    /// </summary>
    [SugarColumn(ColumnDescription = "触发器类型", ColumnName = "TRIGGER_TYPE", ColumnDataType = "NVARCHAR(8)", IsNullable = false)]
    public string TriggerType { get; set; }

    /// <summary>
    /// 触发开始时间
    /// </summary>
    [SugarColumn(ColumnDescription = "触发开始时间", ColumnName = "START_TIME", ColumnDataType = "BIGINT", IsNullable = false)]
    public long StartTime { get; set; }

    /// <summary>
    /// 触发截止时间
    /// </summary>
    [SugarColumn(ColumnDescription = "触发截止时间", ColumnName = "END_TIME", ColumnDataType = "BIGINT", IsNullable = true)]
    public long? EndTime { get; set; }

    /// <summary>
    /// 日历名字
    /// </summary>
    [SugarColumn(ColumnDescription = "日历名字", ColumnName = "CALENDAR_NAME", ColumnDataType = "NVARCHAR(200)", IsNullable = true)]
    public string? CalenderName { get; set; }

    /// <summary>
    /// 失败的指令。
    /// </summary>
    [SugarColumn(ColumnDescription = "失败的指令。", ColumnName = "MISFIRE_INSTR", ColumnDataType = "INTEGER", IsNullable = true)]
