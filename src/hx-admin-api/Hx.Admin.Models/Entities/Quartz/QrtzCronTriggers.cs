...
public class QrtzCronTriggers//:EntityBase<int>
{
    ...
    ///Cron表达式
    /// </summary>
    [SugarColumn(ColumnDescription = "Cron表达式", ColumnName = "CRON_EXPRESSION", ColumnDataType = "NVARCHAR(250)", IsNullable = false)]
    public string CronExpression { get; set; }

    /// <summary>
    ///时区id
    /// </summary>
    [SugarColumn(ColumnDescription = "时区id", ColumnName = "TIME_ZONE_ID", ColumnDataType = "NVARCHAR(80)",IsNullable =true)]
