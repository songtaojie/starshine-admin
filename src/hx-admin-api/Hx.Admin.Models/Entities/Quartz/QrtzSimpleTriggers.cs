...
public class QrtzSimpleTriggers//:EntityBase<int>
{
    ...
    ///重复次数
    /// </summary>
    [SugarColumn(ColumnDescription = "重复次数", ColumnName = "REPEAT_COUNT", ColumnDataType = "BIGINT", IsNullable = false)]
    public long RepeatCount { get; set; }

    /// <summary>
    ///重复间隔
    /// </summary>
    [SugarColumn(ColumnDescription = "重复间隔", ColumnName = "REPEAT_INTERVAL", ColumnDataType = "BIGINT", IsNullable = false)]
    public long RepeatInterval { get; set; }

    /// <summary>
    ///触发次数
    /// </summary>
    [SugarColumn(ColumnDescription = "触发次数", ColumnName = "TIMES_TRIGGERED", ColumnDataType = "BIGINT", IsNullable = false)]
