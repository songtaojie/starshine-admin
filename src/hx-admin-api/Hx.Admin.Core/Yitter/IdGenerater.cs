...
public static class IdGenerater
{
    ...
    public static byte WorkerIdBitLength { get; private set; } = 6;

    public static void SetWorkerIdBitLength(byte workerIdBitLength)
    {
        if (workerIdBitLength == 0) workerIdBitLength = 6;
        WorkerIdBitLength = workerIdBitLength;
    }

    public static byte SeqBitLength { get; private set; } = 6;

    public static void SetSeqBitLength(byte seqBitLength)
    {
        if (seqBitLength == 0) seqBitLength = 6;
